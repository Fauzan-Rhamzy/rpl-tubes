...
--ADMIN : Memasukkan data ke tabel Admin dari tabel Users berdasarkan Role = 'Admin'
...
-- CATATAN VITAL : YANG DIMASUKKIN CATATAN VITAL 20 PASIEN AJA
...
-- dr. Andreas Siregar, SpPD
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Andreas Siregar, SpPD')); -- Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Andreas Siregar, SpPD')); -- Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (10, 'Jumat', '14:00', '16:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Andreas Siregar, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Andreas Siregar, SpPD')); -- Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
...
-- dr. Maria Eva, SpPD
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Maria Eva, SpPD')); -- Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Maria Eva, SpPD')); -- Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (10, 'Minggu', '13:00', '15:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Maria Eva, SpPD'));

-- dr. Fauziah Heny, SpPD (Masuk: Senin, Rabu, Kamis, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (20, 'Senin', '13:00', '16:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Fauziah Heny, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Fauziah Heny, SpPD'));  --Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Fauziah Heny, SpPD'));   --Tidak masuk
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (10, 'Sabtu', '08:00', '11:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Fauziah Heny, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Fauziah Heny, SpPD'));   --Tidak masuk

-- dr. Kevin Wibisono, SpPD (Masuk: Senin, Selasa, Jumat)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Kevin Wibisono, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Kevin Wibisono, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (15, 'Jumat', '09:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Kevin Wibisono, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Kevin Wibisono, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Kevin Wibisono, SpPD'));

-- dr. Yuliana Kurniawan, SpPD (Masuk: Senin, Rabu, Jumat, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (12, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Yuliana Kurniawan, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Yuliana Kurniawan, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Yuliana Kurniawan, SpPD'));
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	...
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES (NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Yuliana Kurniawan, SpPD'));

-- DOKTER GIGI: 
-- drg. Alexander Tampubolon (Masuk: Senin, Selasa, Rabu, Kamis, Jumat)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	...
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Alexander Tampubolon')),
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Alexander Tampubolon'));

-- drg. Novita Afni (Masuk: Senin, Selasa, Kamis, Sabtu, Minggu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	...
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Novita Afni')),
	(15, 'Kamis', '07:30', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'drg. Novita Afni')),
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Novita Afni')),
...
-- drg. Dian Prasetyo (Masuk: Senin, Selasa, Kamis, Jumat, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	...
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Dian Prasetyo')),
	...
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Dian Prasetyo'));

-- drg. Amelia Wijaya (Masuk: Senin, Selasa, Rabu, Jumat, Minggu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	...
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Amelia Wijaya')),
	(14, 'Jumat', '13:30', '17:30', (SELECT NPA FROM Dokter WHERE Nama = 'drg. Amelia Wijaya')),
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Amelia Wijaya')),
	(11, 'Minggu', '10:00', '14:00', (SELECT NPA FROM Dokter WHERE Nama = 'drg. Amelia Wijaya'));

-- drg. Ronald Hutapea (Masuk: Senin, Selasa, Kamis, Jumat, Minggu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	...
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Ronald Hutapea')),
	...
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'drg. Ronald Hutapea')),
	(9, 'Minggu', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'drg. Ronald Hutapea'));

-- DOKTER MATA
-- dr. Lukman Hakim, SpM(K)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(10, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Senin kerja
	(12, 'Selasa', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Selasa kerja
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Rabu libur
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Kamis libur
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Jumat libur
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')), -- Sabtu libur
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Lukman Hakim, SpM(K)')); -- Minggu libur

-- dr. Silvia Tjandra, SpM
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(12, 'Senin', '08:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Senin kerja
	(10, 'Selasa', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Selasa kerja
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Rabu libur
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Kamis libur
	(14, 'Jumat', '13:30', '17:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Jumat kerja
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')), -- Sabtu libur
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Silvia Tjandra, SpM')); -- Minggu libur

-- dr. James Kusuma, SpM
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(14, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Senin kerja
	(12, 'Selasa', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Selasa kerja
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Rabu libur
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Kamis libur
	(13, 'Jumat', '13:00', '17:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Jumat kerja
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')), -- Sabtu libur
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. James Kusuma, SpM')); -- Minggu libur

-- dr. Angela Putri, SpM
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(12, 'Senin', '08:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Senin kerja
	(NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Selasa libur
	(9, 'Rabu', '10:00', '14:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Rabu kerja
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Kamis libur
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Jumat libur
	(8, 'Sabtu', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')), -- Sabtu kerja
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Angela Putri, SpM')); -- Minggu libur

-- dr. Felix Sudarmono, SpM
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(10, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Senin kerja
	(NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Selasa libur
	(11, 'Rabu', '10:00', '14:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Rabu kerja
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Kamis libur
	(15, 'Jumat', '13:00', '17:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Jumat kerja
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')), -- Sabtu libur
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Felix Sudarmono, SpM')); -- Minggu libur

-- DOKTER ANAK: 
-- dr. Reza Mahendra, SpA (Senin, Kamis, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(12, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')), 
	(NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')), -- Tidak masuk
	(10, 'Rabu', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')), 
	(14, 'Kamis', '07:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')), 
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')), -- Tidak masuk
	(15, 'Sabtu', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')),
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Reza Mahendra, SpA')); -- Tidak masuk

-- dr. Nurul Arifah, SpA (Senin, Jumat)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(12, 'Senin', '08:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')),
	(NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')), -- Tidak masuk
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')), -- Tidak masuk
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')), -- Tidak masuk
	(13, 'Jumat', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')),
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')), -- Tidak masuk
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Nurul Arifah, SpA')); -- Tidak masuk

-- dr. Gabriel Manulang, SpA (Selasa, Kamis, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(NULL, 'Senin', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')), -- Tidak masuk
	(10, 'Selasa', '09:00', '13:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')),
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')), -- Tidak masuk
	(12, 'Kamis', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')),
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')), -- Tidak masuk
	(14, 'Sabtu', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')),
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Gabriel Manulang, SpA')); -- Tidak masuk

-- dr. Jessica Anggraeni, SpA (Senin, Kamis)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(12, 'Senin', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')),
	(NULL, 'Selasa', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')), -- Tidak masuk
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')), -- Tidak masuk
	(10, 'Kamis', '08:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')),
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')), -- Tidak masuk
	(NULL, 'Sabtu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')), -- Tidak masuk
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Jessica Anggraeni, SpA')); -- Tidak masuk

-- dr. Alvina Tarigan, SpA (Selasa, Sabtu)
	INSERT INTO Jadwal_Dokter (Kuota_Pasien, Hari, Jam_Mulai, Jam_Selesai, NPA)
	VALUES 
	(NULL, 'Senin', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')), -- Tidak masuk
	(10, 'Selasa', '08:30', '12:30', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')),
	(NULL, 'Rabu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')), -- Tidak masuk
	(NULL, 'Kamis', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')), -- Tidak masuk
	(NULL, 'Jumat', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')), -- Tidak masuk
	(15, 'Sabtu', '08:00', '12:00', (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')),
	(NULL, 'Minggu', NULL, NULL, (SELECT NPA FROM Dokter WHERE Nama = 'dr. Alvina Tarigan, SpA')); -- Tidak masuk
